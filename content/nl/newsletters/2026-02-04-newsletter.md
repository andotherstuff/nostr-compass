...
[Formstr](https://github.com/abh3po/nostr-forms), de Nostr-native formulieren-applicatie, voegde formulier-import en versleutelde formulier-ondersteuning toe in [PR #422](https://github.com/abh3po/nostr-forms/pull/422). Gebruikers kunnen nu bestaande formulieren importeren van JSON of andere Formstr-instanties. De encryptiefunctie stelt formuliercreators in staat om antwoorden te beperken zodat alleen aangewezen ontvangers inzendingen kunnen lezen, bruikbaar voor enquêtes die gevoelige informatie verzamelen.

### Pollerama

[Pollerama](https://pollerama.fun), gebouwd op de [nostr-polls](https://github.com/abh3po/nostr-polls) library, voegde [NIP-17](/nl/topics/nip-17/) DM-delen voor polls toe via [PR #141](https://github.com/abh3po/nostr-polls/pull/141) en [PR #142](https://github.com/abh3po/nostr-polls/pull/142). Gebruikers kunnen nu polls direct naar contacten delen via versleutelde directe berichten.
...
[NIP-17 (Privéberichten)](/nl/topics/nip-17/) gebruikt gift wrap voor versleutelde DM's, ter vervanging van het oudere NIP-04-schema. Het voorgestelde NIP-FR (friends-only notes) gift-wrapt notities naar elke wederzijdse volger. NIP-9a (push notifications) versleutelt notificatie-payloads volgens gift wrap-principes.
