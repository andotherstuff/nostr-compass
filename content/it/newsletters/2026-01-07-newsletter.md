...
**Mostro v0.15.6** - L'[ultimo rilascio](https://github.com/MostroP2P/mostro/releases/tag/v0.15.6) della piattaforma di trading P2P Bitcoin [NIP-69](/it/topics/nip-69/) completa l'implementazione del fondo di sviluppo con gli eventi di audit della Fase 4. I pagamenti delle commissioni dev sono ora tracciati tramite eventi Nostr kind 38383 pubblicati dopo ogni pagamento riuscito, abilitando verifica e analytics di terze parti. I calcoli degli importi sono stati corretti per i messaggi acquirente/venditore, e la logica del premium è stata allineata con l'implementazione di riferimento lnp2pbot.
