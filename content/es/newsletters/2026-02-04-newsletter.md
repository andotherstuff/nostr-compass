...
[Frostr](https://frostr.org/) lanzó [Igloo para iOS](https://github.com/FROSTR-ORG/igloo-ios-prototype) en [TestFlight](https://testflight.apple.com/join/72hjQe3J), expandiendo firma de umbral a dispositivos Apple. Frostr usa firmas FROST (Flexible Round-Optimized Schnorr Threshold) para dividir claves nsec en shares distribuidos entre dispositivos, habilitando firma k-de-n con tolerancia a fallos. Los usuarios que se unen en "modo demo" participan en un experimento de firma de umbral 2-de-2 en vivo, demostrando las capacidades de coordinación en tiempo real del protocolo. El lanzamiento iOS se une a [Igloo para Android](https://github.com/FROSTR-ORG/igloo-android) (v0.1.2), que se lanzó en diciembre con soporte [NIP-55 (Firmante Android)](/es/topics/nip-55/) para solicitudes de firma entre apps. Ambos clientes móviles complementan [Igloo desktop](https://github.com/FROSTR-ORG/igloo-desktop) y la extensión de navegador [Frost2x](https://github.com/FROSTR-ORG/frost2x).
...
[NIP-17 (Mensajes Directos Privados)](/es/topics/nip-17/) usa gift wrap para DMs cifrados, reemplazando el esquema anterior NIP-04. El propuesto NIP-FR (notas solo-amigos) envuelve notas para cada seguido mutuo. NIP-9a (notificaciones push) cifra cargas de notificación usando principios de gift wrap.
