...
### NIP-34 activity: joinmarket-ng and Iris

[joinmarket-ng](https://joinmarket-ng.github.io/joinmarket-ng/), a modern alternative implementation of [JoinMarket](https://github.com/JoinMarket-Org/joinmarket-clientserver) (Bitcoin CoinJoin), pushed 13 patches to its [ngit-hosted git repo](https://relay.ngit.dev/npub1w3vaxva0vcrx7pnvlpmede5smvafdl69xnu7ma82kaxl9us89zdsht4c5c/joinmarket-ng.git) this week. JoinMarket coordinates CoinJoin transactions over Tor; joinmarket-ng is the first NIP-34-native re-implementation, and the patch flow this week is the largest sustained activity on any tracked NIP-34 repo since the [NIP-34 tracker](/en/topics/nip-34/) started monitoring.
