...
February 2026, documented across Compass issues #8 through #11, spanned peer-to-peer trading, app distribution, private messaging, agent tooling, and mesh networking. [Mostro](https://github.com/MostroP2P/mostro) shipped its first public beta for decentralized peer-to-peer Bitcoin trading, [Zapstore](https://github.com/zapstore/zapstore) reached 1.0 after its release-candidate cycle, and [White Noise](https://github.com/marmot-protocol/whitenoise) delivered real-time Marmot-encrypted messaging with external signer support. Mature protocol components now supported markets, app distribution, and private group coordination rather than only public social feeds.

Competing AI-agent proposals arrived alongside a DVM coordination design extending [NIP-90](https://github.com/nostr-protocol/nips/blob/master/90.md). [ContextVM](https://github.com/ContextVM) connected Model Context Protocol tooling to Nostr transport, while [Burrow](https://github.com/CentauriAgent/burrow) applied Marmot-encrypted messaging to both agents and humans. The notable transition was architectural: identity, payments, job requests, and private channels could now be composed for machine participants as well as people.
