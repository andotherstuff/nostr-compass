...
[NIP-F4](https://github.com/nostr-protocol/nips/blob/master/F4.md) merged this week, two years and three months after fiatjaf opened the original draft (PR #1093). Its "F" prefix marks an experimental NIP awaiting a numeric assignment, alongside other hex-prefixed entries like NIP-5A and NIP-C7. NIP-F4 defines how podcasts publish episodes and metadata as Nostr events while keeping RSS as a complementary layer for the audio file itself.
