...
draft: false
type: newsletters
description: "Amethyst 1.13.1 adds authenticated group and Blossom access after 1.13.0 introduced Nostr apps; Mosaico shares coding-agent status over Nostr, and Nostrology maps NIP-65 relay-list concentration."
---

Welcome back to [Nostr Compass](https://github.com/andotherstuff/nostr-compass), your weekly guide to Nostr.

**This week:** [Amethyst 1.13.1](https://github.com/vitorpamplona/amethyst/releases/tag/v1.13.1) follows version 1.13.0's Nostr-app launch with NIP-29 host-relay authentication and authenticated Blossom-download retries. [Code Call](https://github.com/tidley/nostr-codex-phone/releases/tag/v0.2.68) keeps remote coding sessions moving from a phone, [GitWorkshop](https://github.com/DanConwayDev/gitworkshop) coordinates maintainers and repository synchronization, and [Mosaico](https://github.com/pablof7z/mosaico/releases/tag/v0.1.2) gives coding agents a shared Nostr awareness layer. [Nostrology](https://dev.nostrolo.gy/relays) maps how profiles divide read and write duties across their published relay lists. Android releases from [Mafrend](https://github.com/DestBro/mafrend-zapstore/releases/tag/v1.0), [Hanami](https://github.com/Letdown2491/hanami-android/releases/tag/v0.1.0), and [Cordn](https://github.com/Cordn-msg/cordn-web/releases/tag/v0.2.1) lead the tagged releases, while [FIPS adds an OpenWrt access layer](https://github.com/jmcorgan/fips/pull/126) and an [open PR proposes a FreeBSD port](https://github.com/jmcorgan/fips/pull/129). Protocol coverage reports NIPs, BUDs, NAPs, Marmot, Gamma Markets, Concord, and NWC, while [Six Years of Nostr Julys](https://github.com/nostr-protocol/nips/commits/master/) follows July changes from early domain lookup through relay-group state.
## Top Stories
...
Payment routing became composable too. The July 31 [NIP-57 zap-splits merge](https://github.com/nostr-protocol/nips/commit/5d63b1570c490007252b10e757f7f68ef1f4b717) changed a single `zap` destination into a weighted list of recipient pubkeys and relay hints. A client could divide one zap among collaborators, omit unweighted recipients when some weights were present, and show the split before payment. The change standardized a signed-event representation for weighted zap recipients and relay hints, allowing compatible clients to present the split before payment.
