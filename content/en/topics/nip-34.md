...
- [joinmarket-ng](https://gitworkshop.dev/joinmarket-ng/joinmarket-ng) is a modern JoinMarket (Bitcoin CoinJoin) alternative implementation. It is one of the heaviest active NIP-34 users by patch volume, with continuous patch flow through `relay.ngit.dev`. The project shows that NIP-34 can carry real-world Bitcoin protocol development workflows.
