...
async function roleEvidenceValid(value: RoleReceipt): Promise<boolean> {
  ...
  const retainedSourceCount = Array.isArray(ledger.editorial_sources) ? ledger.editorial_sources.length : -1;
