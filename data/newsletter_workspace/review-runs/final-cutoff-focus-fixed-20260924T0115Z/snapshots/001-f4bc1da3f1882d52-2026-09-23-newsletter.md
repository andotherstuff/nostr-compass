...
The [app listing](https://zapstore.dev/apps/org.tablemesh.app) describes the Bluetooth mesh as tested in simulation and emulators, not yet at real multi-phone tables. Nostr is used to discover and deliver optional games; the actual table session runs locally without an internet connection or account.
