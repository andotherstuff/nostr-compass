...
### pakstr 0.21.0–0.24.0 hardens Android Nostr signing

[pakstr](https://git.nostrdev.com/stuff/pakstr) is a packaging system and application shell for distributing web applications with native Nostr capabilities. NIP-46 defines remote-signer sessions, NIP-98 defines signed HTTP authentication, and NIP-55 lets Android applications request signatures from an external signer. [Version 0.21.0](https://git.nostrdev.com/stuff/pakstr/releases/tag/v0.21.0) adds production bunker pairing and authenticated proxy requests; [0.22.0](https://git.nostrdev.com/stuff/pakstr/releases/tag/v0.22.0) adds NIP-55 signing through the bunker; [0.23.0](https://git.nostrdev.com/stuff/pakstr/releases/tag/v0.23.0) persists the Android runtime API address.

The [0.21.0 release](https://git.nostrdev.com/stuff/pakstr/releases/tag/v0.21.0) also repairs invalid-relay cleanup and Amber pairing. [Version 0.24.0](https://git.nostrdev.com/stuff/pakstr/releases/tag/v0.24.0) publishes the Zapstore icon; its icon change is not the signer milestone. NostrAppShell entries point to the same package series, so they are covered here once.
...
### Zzub 0.0.15 brings code review to mobile project boards
