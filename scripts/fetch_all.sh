...
#   8. fetch_spec_updates.py          (NIP, BUD, NAP, Marmot, Gamma, Concord, NWC specs)
#
# Prerequisites:
...
# 8. Protocol/spec-family activity (GitHub)
echo "[8/8] Specification families (NIP / BUD / NAP / Marmot / Gamma / Concord / NWC)..."
