...
**Kind ranges** (from [NIP-01](https://github.com/nostr-protocol/nips/blob/master/01.md)):
- **0-999**: Regular events (all versions kept)
- **1000-9999**: Regular events (continued)
- **10000-19999**: Replaceable events (only latest per pubkey kept)
- **20000-29999**: Ephemeral events (not stored, just forwarded)
- **30000-39999**: Addressable events (latest per pubkey + kind + d-tag)
...
## Authentication and Wallet (22000-27999)
